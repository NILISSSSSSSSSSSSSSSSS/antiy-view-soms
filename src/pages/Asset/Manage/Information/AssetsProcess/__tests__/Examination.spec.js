...
describe('<Examination />', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<Examination {...props}/>).dive(options).dive(options)
  ...
  it('render <Examination /> component', () => {
  ...
  it('testFunc conOnProgressShow',  ()=> {
    const Arr = [6, 7, 8, 9, 10, 11]
    Arr.forEach(item=>{
      instance.conOnProgressShow(item)
      wrapper.find('.operate a').simulate('click')
    })
  })
  ...
  it('shoulder render a Examination',  ()=> {
