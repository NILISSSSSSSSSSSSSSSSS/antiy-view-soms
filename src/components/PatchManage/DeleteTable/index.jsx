...
class DeleteTable extends PureComponent {
  ...
  render () {
    const { pageSize, current, body, onChange, columns, isShow, isDelete, isCheck, onDelete, rowSelection, url, isTargetBlank, rowKey = 'stringId', showSizeChanger = true } = this.props
    isShow && columns.push({
      title: '操作',
      dataIndex: 'stringId',
      key: 'stringId',
